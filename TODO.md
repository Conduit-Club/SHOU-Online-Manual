...
- [ ] 项目仍处于内容迁移与核验阶段，校园服务、生活和应急信息尚未完整。
...
- [ ] 修正[站点帮助](docs/site-help/README.md)中的 `Andoid` 拼写，并核验 PWA 安装说明。
- [ ] 统一内容条目的来源、适用校区/对象、适用学年和最近核验日期。
- [ ] 检查内部链接、外部链接、图片、PDF 和地图资源。
- [ ] 统一源码中 `.md`、`.html` 和目录形式的站内链接。
- [ ] 为校历、交通、电话、开放时间、价格和政策建立定期复核机制。
