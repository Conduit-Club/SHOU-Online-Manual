...
依据：[学生申请资格与材料](https://docs.github.com/en/education/about-github-education/github-education-for-students/apply-to-github-education-as-a-student)、[Student Developer Pack 条款](https://docs.github.com/en/education/about-github-education/github-education-for-students/github-terms-and-conditions-for-the-student-developer-pack)。

### 兑换顺序

1. 登录自己的 GitHub 账号，从[学生申请页](https://education.github.com/pack/join)完成学生身份认证。
2. 通过后打开[学生包福利列表](https://education.github.com/pack)，找到要用的服务，进入该项目的领取入口。
3. 在合作伙伴官网注册或登录本人账号，按页面要求关联 GitHub、完成资格核验或领取优惠码。
...
旧教程和此前页面曾介绍 DigitalOcean 学生额度。截至本次核验，[GitHub 学生包](https://education.github.com/pack#offers)已没有 DigitalOcean 条目，[原学生兑换入口](https://www.digitalocean.com/github-students)也会跳转到主页，因此不再将旧的 100 或 200 美元额度列为当前可领取福利。

如果已经领取过额度，请以 DigitalOcean 账号中的余额、到期日和账单为准。普通新用户活动有独立条件，不能与 GitHub 学生包优惠混写。需要云服务器练习时，可先查看上表 Azure 的学生额度及适用范围。

## 其他申请入口与授权规则

### JetBrains 学生授权

- **福利与入口**：从 [JetBrains 学生申请页](https://www.jetbrains.com/shop/eform/students)申请 IntelliJ IDEA Ultimate、PyCharm Professional、CLion、Rider、WebStorm 等开发工具的教育授权。
- **申请条件**：就读经认证教育机构、至少一年的全日制学习项目；可通过学校邮箱、ISIC 或 GitHub 等方式验证资格。已有 GitHub 学生包时，可以用该学生身份申请，无需只依赖邮箱域名被识别。
- **通过学生包领取**：从学生包的 JetBrains 条目进入申请流程，选择 GitHub 验证并关联已认证的账号。收到获批邮件后，将授权绑定到 JetBrains Account，再用该账号登录 Toolbox 或 IDE 激活。
- **有效期**：1 年；仍符合学生资格时可续期。
- **使用限制**：仅限非商业教育用途，包括学术研究，不可将教育授权用于商业项目。

依据：[学生资格 FAQ](https://sales.jetbrains.com/hc/en-gb/articles/11557849416594-Who-is-eligible-for-free-individual-educational-licenses)、[授权申请方式](https://sales.jetbrains.com/hc/zh-cn/articles/207154369)（2026-07-14 更新）、[通过 GitHub 学生包领取的官方说明](https://blog.jetbrains.com/education/2018/09/18/free-jetbrains-licenses-as-part-of-github-student-developer-pack/)、[教育授权条款第 3.1、5.1 条（PDF）](https://www.jetbrains.com/legal/docs/toolbox/license_educational/3.0/3.0.pdf)。
...
- **使用限制**：用于教育、教学、非商业研究及相关开发测试，额度不能用于 Azure Marketplace。免费服务也有用量上限；升级即用即付前应检查资源和计费设置。

依据：[学生包 Azure 条目](https://education.github.com/pack#offers)、[Azure for Students 说明](https://learn.microsoft.com/en-us/azure/education-hub/about-azure-for-students)、[套餐条款](https://azure.microsoft.com/en-us/pricing/offers/ms-azr-0170p/)、[Microsoft Learn 教育计划 FAQ](https://learn.microsoft.com/zh-cn/azure/education-hub/azure-dev-tools-teaching/program-faq)。Azure for Students Starter 是另一个计划，条件不能混用。

### Autodesk Education

- **福利与入口**：[Autodesk 学生教育计划](https://www.autodesk.com/education/students)提供 AutoCAD、Revit、Fusion 等教育软件和服务的单用户访问权限，具体产品以申请页为准。
- **申请条件**：达到服务要求的最低年龄，就读合格教育机构，并通过 Autodesk / SheerID 的资格核验；可能需要补充在读证明，学校邮箱本身不一定足够。
- **有效期**：1 年，仍符合资格可按年续期；可在到期前 30 天开始续期。到期后免费访问结束，应提前导出需要保留的文件。
